        ...
        <div className="main-left">
          <Card active={true}>
            ...
            <CardDescription>
              ...
              перейдите на страницу &quot;Play&quot;. Также используется специальная нотация для возможности сохранения
              и загрузки игры.
            </CardDescription>
          </Card>
        </div>
          ...
          <Card active={true}>
            ...
            <CardList>
              ...
              <li>
                ...
                которые наступала шашка во время хода, разделенные двоеточием (если было взятие при текущем переходе)
                или тире (если текущий переход тихий).
                <br />
                <Span italic={true}>
                  Например: c5:e3:g5 (при условии, что на d4 и f4 были пешки и такой ход разрешен правилами текущей
                  игры)
                </Span>
              </li>
            </CardList>
